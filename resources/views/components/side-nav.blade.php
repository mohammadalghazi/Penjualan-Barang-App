<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse h-auto w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <x-side-nav-item active="{{ Request::is('dashboard/invoices') }}" href="/dashboard/invoices" icon="document-text-outline">Invoices</x-side-nav-item>
            <x-side-nav-item active="{{ Request::is('dashboard/returns') }}" href="/dashboard/returns" icon="repeat-outline">Return</x-side-nav-item>
